...
import com.eventsapp.osmGeocoding
...
interface ApiService {
    ...
    @GET("geocoding/v5/mapbox.places/{urlencode}.json?country=ru&access_token=pk.eyJ1Ijoidm9jYWxpbnRlcm5ldCIsImEiOiJjbDVyeXE4NGQwaTZoM2puMGY5am1xbnRoIn0.PV25RxZ_UUxxZx7Y5fbkoA")
    suspend fun getCoordsLocation(@Path("urlencode") address: String?): Response<GeocodingLocation>

  //  @GET("search?&limit=1&format=json")
   // suspend fun getLL(@Query("q") address: String?): Response<osmGeocoding>

    @GET("?apikey=5217db62-84ee-4c9b-ab78-0251c632dc6b&format=json&results=1")
    suspend fun getLL(@Query("geocode") address: String?): Response<yaGeocoding>
...
//curl -X GET "https://api.timepad.ru/v1/events?starts_at_max=2022-07-21&cities=Москва" -H  "accept: application/json" -H "Authorization: Bearer 9c656d513c21316fdc77e5ff886cfc0f0e6f1f03"